...
*   `npm run generate-data`, `npm run gen-data`: Create group data in JSON format
*   `npm run sanitize-data`, `npm run san-data`: Sanitize group data and output in JSON format (should run after `npm run generate-data`)
